...
- Maintains a single project home at `<vault>/<projectsSubfolder>/<home>.md` (or the directory `<home>/` once promoted) — path resolution is `tool.obsidian-notes`' job, and this mode just consumes the resolved home.
